...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Reportes por Tipo De Servicio</h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row TitulodeListaReportes">
                                <div class="col-xl-12">
                                    <h2>Lista Cantidad Total de Servicio Mas usados</h2>                                
                                </div>
                            </div>
                            ...
                            <div id="datosagregar" class="table-responsive">
    ...
    <script src="../../Js/reportetiposervicio.js"></script>
