...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Reportes por Fecha</h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row TitulodeListaReportes">
                                <div class="col-xl-12">
                                    <h2>Lista de clientes con sus respectivos servicios</h2>                                
                                </div>
                            </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-5 col-sm-5 col-md-3 col-lg-3 col-xl-2 cbuscar">   
                                    <div class="form-group"> 
                                        <label >  </label>
                                ...
                                <div class="col-sm-12 col-md-5 col-lg-4 col-xl-4 generarReportePDF">
                                    <div class="form-group">                                      
                            ...
                            <div id="listadoreportesxfecha" class="table-responsive">
    ...
    <script src="../../Js/reportesfecha.js"></script>
