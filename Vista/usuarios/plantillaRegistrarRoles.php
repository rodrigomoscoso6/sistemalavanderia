                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Registre un Rol</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-row">
                                                    ...
                                                    <input type="text" class="form-control" name="nombrerol" id="nombrerol" placeholder="Ingrese nuevo rol" required>
                                                    </div>                                                  
                                            </div>
                            ...
                            <div id="tablarol" class="table-responsive">
