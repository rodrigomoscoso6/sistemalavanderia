...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Servicios de Entrada</h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-6 ">
                                    <a id="btnRegistrarCliente" href="plantillaAdicionarNuevoServicioEntrada.php" role="button" class="btn p4 btn-outline-primary btnRegistrarNuevo">
                                ...
                                <div class="col-xl-6">
                                    <div class="row contenedorfechaybuscador">
                                        <div class="col-xl-2">
                                        ...
                                        <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-6 ">
                                            <button type="button" id="buscador" class="btn btn-primary">Buscar</button> 
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div id="listadoservicioentrada" class="table-responsive"> 
    ...
    <script src="../../Js/ListadoServicioEntrada.js"></script>
