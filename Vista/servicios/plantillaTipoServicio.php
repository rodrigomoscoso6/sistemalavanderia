...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Registro de Nuevo Tipo de Servicio</h6>
                        </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Registro de Tipo de Servicios</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form id="frmregistrartiposervicio">
                                            <div id="inputidtiposervicio">
                                            </div>                                           
                                            <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                    <label >Tipo de Servicio</label>
                                                    <input type="text" class="form-control" name="tipo_servicio" id="tipo_servicio" placeholder="Tipo de Servicios" required>
                                                    </div>
                                                </div>
                                                <div class="form-row">                                                   
                                                    <div class="form-group col-md-6">
                                                    <label >Medida</label>
                                                    <input type="text" class="form-control" name="medida" id="medida"  placeholder="Ingrese la Medida" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    <label >Precio</label>
                                                    <input type="text" class="form-control" name="precio" id="precio"  placeholder="Ingrese su precio" required>
                                                    </div>                                                   
                                                </div>
                                                <div class="form-row">     
                                                    <div class="form-group col-md-12">
                            ...
                            <div class="modal fade" id="ModalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div id="formeditar" class="modal-body">
                                ...
                                <!-- Terminado Modal -->
                                <div id="traertabla" class="table-responsive">
    ...
    <script src="../../Js/tipo_servicio.js"></script>
