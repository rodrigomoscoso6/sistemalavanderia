$(document).ready(function(){
    ...
    function ReporteTipoServicio()
    {
        ...
        $.ajax({
            url : "../../ajax/reportes/Ajax_reportetipoServicio.php"		
        }).done(function(response){
        
            $("#datosagregar").html(response);

            $('#reportetiposervicio').DataTable(
                {
            ...
            {
                location.href = "../mpdfgeneral/mpdfreportestiposervicio.php?accion=mostratodo";
            })
    ...
    function ReporteTipoServiciofecha()
    {
        $("#buscar").click(function(event)
        {
            ...
            $.ajax({
                url: "../../ajax/reportes/Ajax_reportetipoServicioFecha.php",
                type: 'POST',
            ...
            }).done(function(response)
            {
                ...
                $('#botonreporte').click(function()
                {
                    ...
                    location.href = "../mpdfgeneral/mpdfreportestiposervicio.php?accion=filtro&fechainicio=" + f_inicio +"&fechafin=" + f_fin;               
                })
