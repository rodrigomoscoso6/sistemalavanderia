...
$result = $controladorreportesxfecha->listadoReportesFechaInicioFechaFin($fechainicio, $fechafin);
echo "<table id='tablaxfechainicioyfechafin' class='table table-striped table-bordered' style='width:100%'>
